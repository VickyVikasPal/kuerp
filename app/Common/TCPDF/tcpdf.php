	...
	*/
    ...
    protected function fileExists($file)
    {
		if (isset($this->fileContentCache[$file])) {
			...
			$fileContent = $this->fileContentCache[$file];
		} else {
			// Read and process the file
			$fileContent =TCPDF_STATIC::fileGetContents($file);
			$this->fileContentCache[$file] = $fileContent; // Store the content in the cache for future use
		}
