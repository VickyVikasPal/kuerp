...
class GlobalSettings extends SoftdevModel
{
    public static $auditingDisabled = true; // if true then audit will be disabled
    public $individualAudit = false; // if true then audit data will be inserted this particlur model table
