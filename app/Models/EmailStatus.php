 ...
 * @method static Builder|User whereEmailStatus($value)
 * @method static Builder|User whereEmailStatusVerifiedAt($value)
...
class EmailStatus extends SoftdevModel
{
