 ...
 *********************************************************************************/
namespace App\Modules\DeliveryChallans\Pdf;
...
class HealDeliveryChallan extends Healpdf
{
...
// Add a page
        ...
        $deliveryObj = new DeliveryChallan();
        $delivery_data = DeliveryChallan::find($id);
        $prefix = "";
        $options = array('tableName'=>$deliveryObj->table, 'branch_id'=>$delivery_data->branch_id);
        $prefix = $generateKey->autoGeneratePrefix($options);

        $client_data = ClientMaster::find($delivery_data->parent_id);
        /*================ customer Data Area =====================*/
            ...
            <td width="45%">
                <table cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td width="20px">:</td>
                        <td width="200px">'.$prefix.'-'.$delivery_data->delivery_no.'</td>
                    </tr>
                    <tr>
                        <td width="100px"><b>Date</b></td>
                        <td width="20px">:</td>
                        <td>'.$datetime->to_display_date($delivery_data->date_entered).'</td>
                    </tr>
                    <tr>
...
$items = DeliveryChallanItem::where('parent_id', $id)->where('deleted', 0)->get();
// ---------------------------------------------------------
...
// Close and output PDF document
        // This method has several options, check the source code documentation for more information.
        $this->Output($delivery_data->delivery_no.'.pdf', 'I');
