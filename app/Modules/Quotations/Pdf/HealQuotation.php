...
class HealQuotation extends Healpdf
{
...
// Add a page
        ...
        $qtn_data = Quotation::find($id);
        $prefix = "";
        $options = array('tableName'=>$qtnObj->table, 'branch_id'=>$qtn_data->branch_id);
        $prefix = $generateKey->autoGeneratePrefix($options);

        $client_data = ClientMaster::find($qtn_data->parent_id);
        /*================ customer Data Area =====================*/
            ...
            <td width="45%">
                <table cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td width="20px">:</td>
                        <td width="200px">'.$prefix.'-'.$qtn_data->quotation_no.'</td>
                    </tr>
                    <tr>
                        <td width="100px"><b>Date</b></td>
                        <td width="20px">:</td>
                        <td>'.$datetime->to_display_date($qtn_data->date_entered).'</td>
                    </tr>
                    <tr>
...
$items = DB::table('quotation_items')->where('parent_id', $id)->where('deleted', 0)->get();
// ---------------------------------------------------------
...
// Close and output PDF document
        // This method has several options, check the source code documentation for more information.
        $this->Output($qtn_data->quotation_no.'.pdf', 'I');
