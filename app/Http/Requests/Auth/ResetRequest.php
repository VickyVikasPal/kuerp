...
class ResetRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'otp.required' => __('The :attribute field is required', ['attribute' => __('OTP')]),
            ...
            'password.min' => __('The :attribute must be at least :min characters', ['attribute' => __('password'), 'min' => 8]),
