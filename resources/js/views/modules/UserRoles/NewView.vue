                        ...
                        <table cellspacing="0" cellpadding="0" class="table m-0 item_table">
                            ...
                            <tbody>
                                <tr v-for="(row, rowIndex) in modules" :key="rowIndex">
                                    <td><b>{{ row }}</b></td>
                                    <td v-for="(option, colIndex) in availableOptions"
                                        v-if="availableOptions && availableOptions.length" :key="colIndex">
...
<script src="@/views/modules/UserRoles/js/NewView.js"></script>