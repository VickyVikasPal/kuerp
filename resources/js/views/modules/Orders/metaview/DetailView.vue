...
<script>
    ...
    import CustomDetail from "@/views/modules/Orders/DetailView.vue";
    import breadcrumbs from "@/views/modules/Orders/MenuList.vue";
    import lang from "@/views/modules/Orders/language/en";
    import GenericMoreButton from "@/components/layout/shared/common/MoreButton.vue";
    import CustomMoreButton from "@/views/modules/Orders/MoreButton.vue";
