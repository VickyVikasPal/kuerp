<template>
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="form-group item-select">
                            ...
                            <input type="hidden" name="" id="clientmaster_parent_id" v-model="quotation.client_id" @change="getCustomer(quotation.client_id)">
                                                ...
                                                <input  type="text" class="form-control" v-model="quotation.client_name" :id="`clientmaster_name`" autocomplete="off" v-on:keyup="queryForKeywords($event, 'clientmaster')" v-on:keydown="queryForKeywords($event, 'clientmaster')"/>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-8 col-8">
                        <div class="form-group item-select">
                            ...
                            <input  type="text" class="form-control" v-model="quotation.product_name" :id="`product_name`" autocomplete="off" v-on:keyup="queryForKeywords($event, 'product')" v-on:keydown="queryForKeywords($event, 'product')"/>
                             <span class="group-select">
                                <span ref="genericSearch"
        ...
        <div class="card mb-2">
            <div class="card-body text-end">
                <button type="button" class="btn btn-success btn-sm" @click="updateQuotation('save')">Save</button>
                <button type="button" class="btn btn-warning btn-sm" @click="updateQuotation('cancel')">Cancel</button>
            </div>
        </div>
 ...
 <script src="@/views/modules/Quotations/js/EditView.js"></script>
