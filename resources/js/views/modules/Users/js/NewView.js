    ...
    methods: {
        ...
        getUser() {
            ...
            if (typeof (self.record) != 'undefined') {
                ...
                axios.get('/modules/users/' + self.$route.params.id).then(function (response) {
        ...
        saveUser() {
            ...
            if (typeof (self.record) == 'undefined' || self.record == '') {
                axios.post('/modules/users', self.user, formData).then(function (response) {
                    self.loading = false;
                    self.$notify({
                ...
                axios.put(`/modules/users/${self.$route.params.id}`, self.user).then(function (response) {
                    self.loading = false;
                    self.$notify({
                        title: self.$i18n.t('Success').toString(),
