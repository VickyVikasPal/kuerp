        ...
        <form @submit.prevent="saveUser" enctype="multipart/form-data">
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="password">{{lang.LBL_USER_PASSWORD}}<span class="required">*</span></label>
                                <input type="password" class="form-control" id="password" v-model="user.password">
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="password_confirmation">{{lang.LBL_CONFIRM_PASSWORD}}<span
                                        class="required">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="textArea" cols="10" rows="2" v-model="user.address_street"></textarea>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="form-group">
            ...
            <div class="card mb-2">
                <div class="card-body text-end">
                    <button btntype="Submit" class="btn btn-success btn-sm">Save</button>
                    <router-link class="btn btn-warning btn-sm" to="/modules/users">Cancel</router-link>
                </div>
            </div>
        </form>
    </div>
...
<script src="@/views/modules/Users/js/NewView.js"></script>