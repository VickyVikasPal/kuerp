...
import CustomList from "@/views/modules/BulkInventorys/ListView.vue";
import searchArray from "@/views/modules/BulkInventorys/metaview/metajs/SearchView.js";
