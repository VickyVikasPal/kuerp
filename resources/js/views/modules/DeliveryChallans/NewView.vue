<template>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="form-group item-select">
                            ...
                            <input type="hidden" name="" id="clientmaster_parent_id" v-model="delivery.client_id" @change="getCustomer(delivery.client_id)">
                                                ...
                                                <input  type="text" class="form-control" v-model="delivery.client_name" :id="`clientmaster_name`" autocomplete="off" v-on:keyup="queryForKeywords($event, 'clientmaster')"/>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-8 col-8">
                        <div class="form-group item-select">
                            ...
                            <input  type="text" class="form-control" v-model="delivery.product_name" :id="`product_name`" autocomplete="off" v-on:keyup="queryForKeywords($event, 'product')"/>
                             <span class="group-select">
                                <span ref="genericSearch"
                               ...
                               <td>{{prod.total_value}}</td>
                                ...
                                <td width="200px" class="p-0">
                                    <table class="table m-0 table-bordered inner-table">
                                        <tbody>
                                            <tr>
                                                <td width="70px">{{prod.cgstRate}}%</td>
                                                <td width="80px">{{prod.cgst}}</td>
                                                <td width="70px">{{prod.sgstRate}}%</td>
                                                <td width="80px">{{prod.sgst}}</td>
                                                <td width="70px">{{prod.igstRate}}%</td>
       ...
       <div class="row">
        ...
        <div class="card mb-2">
            <div class="card-body text-end">
                <button type="button" class="btn btn-success btn-sm" @click="saveDelivery('save')">Save</button>
                <button type="button" class="btn btn-warning btn-sm" @click="saveDelivery('cancel')">Cancel</button>
            </div>
        </div>
 ...
 <script src="@/views/modules/DeliveryChallans/js/NewView.js"></script>
