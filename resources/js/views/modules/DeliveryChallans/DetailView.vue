         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                  <table class="table m-0 detail-item-table">
                     <tr>
                        <td class="w-30 label">{{lang.LBL_DELIVEY_NO}}</td>
                        <td>:</td>
                        <td class="w-70">{{delivery.delivery_no}}</td>
                     </tr>
                     <tr>
                        <td class="w-30 label">{{lang.LBL_DELIVERY_DATE}}</td>
                        <td>:</td>
                        <td class="w-70">{{delivery.delivery_date}}</td>
                     </tr>
                  </table>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                  <table class="table m-0 detail-item-table">
                     <tr>
                        ...
                        <td>:</td>
                        <td class="w-70">{{delivery.date_entered}}</td>
                     </tr>
                     <tr>
                        <td class="w-30 label">{{lang.LBL_DATE_MODIFY}}</td>
                        <td>:</td>
                        <td class="w-70">{{delivery.date_modified}}</td>
                     </tr>
                  </table>
               </div>
            </div>
...
<script src="@/views/modules/DeliveryChallans/js/DetailView.js"></script>