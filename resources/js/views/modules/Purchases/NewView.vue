<template>
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="form-group item-select">
                            <label>{{lang.LBL_VENDOR_NAME}}</label>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <Datepicker :name="'bill_date'" :id="'bill_date'" v-modal="'bill_date'" :calendar-button-icon="'fa-solid fa-calendar-days'"></Datepicker>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <script src="@/views/modules/Purchases/js/NewView.js"></script>
