<template>
    <main>
        ...
        <CustomDetail v-else ref="UpdatePayment"></CustomDetail>
...
<script>
    ...
    import CustomDetail from "@/views/modules/Invoices/DetailView.vue";
    ...
    import CustomMoreButton from "@/views/modules/Invoices/MoreButton.vue";
    import DownloadAction from "@/components/layout/shared/download/Download.vue";

    export default {
        name: "detail-invoices",
        components: {
            breadcrumbs,
            GenericDetail,
            CustomDetail,
        ...
        methods: {
            ...
            UpdatePaymentStatus(){
               ...
               this.$refs.UpdatePayment.UpdatePayment();
            }
        }
    }
