    ...
    methods: {
        ...
        getCustomer(customer_id)
        {
            ...
            axios.get('modules/getcustomers',{params:{'customer_id':customer_id}}).then(function(response){
                ...
                self.invoice.client_id = response.data.client.id;
                self.invoice.client_type = 'clientmasters';
                self.invoice.client_name = response.data.client.name;
        ...
        delRecord(id){
            const self = this;
            self.loading = true;
            axios.post('modules/del_invoices', {'del_id':id}).then(function(response){
        ...
        saveInvoice(actionType){
            ...
            if(actionType == 'save'){
                ...
                axios.post('modules/invoices', {'formData': formData, 'itemData':self.productArray}).then(function(response){
